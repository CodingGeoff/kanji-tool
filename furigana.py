...
# ================================================================
# 当て字（音译借字）整词读音表：按读音配汉字，单字无独立读音意义。
# UniDic 常把它们拆成单字音读/训读而读错（葡萄牙→ぶどう+きば✗，
# 墨西哥→すみ+にし+うた✗，華盛頓→はな+せい+とみ✗）。
# 表优先级最高，整词注音。
# ================================================================
ATEJI = {
    # 国名/地名/外来语借字
    ...
    '瑞西': 'すいす', '丁抹': 'でんまーく', '越南': 'べとなむ',
    '比律賓': 'ふぃりぴん', '濠太剌利': 'おーすとらりあ', '加奈陀': 'かなだ',
    '伊太利亜': 'いたりあ', '阿蘭陀': 'おらんだ', '和蘭': 'おらんだ',
    '瑞典': 'すうぇーでん', '諾威': 'のるうぇー', '希臘': 'ぎりしゃ',
    '桑港': 'さんふらんしすこ', '羅馬': 'ろーま', '伯林': 'べるりん',
    '型録': 'かたろぐ', '洋袴': 'ずぼん', '麦酒': 'びーる',
    '瓦斯': 'がす', '硝子': 'がらす', '護謨': 'ごむ', '莫大小': 'めりやす',
    '麺麭': 'ぱん', '墺太利': 'おーすとらりあ', '蘇俄': 'そびえと',
    '加須底羅': 'かすてら', '金平糖': 'こんぺいとう', '更紗': 'さらさ',
    '愛羅武勇': 'あいらぶゆう', '怒羅悪': 'どらくえ',
